...
$(document).ready(function () {
  ...
  var windowH = document.scrollingElement.scrollTopMax;

  // scroll effects
  $(window).on('scroll', function () {
    var bScroll = document.scrollingElement.scrollTop;

    var scrollPercent = (windowH - bScroll) / windowH * 100;
    console.log(scrollPercent);

    var logoH = calcRange(15, 50, scrollPercent);
    var logoX = calcRange(25, 50, scrollPercent);
    var logoY = calcRange(10, 50, scrollPercent);
    logo.css('height', logoH + 'vh');
    logo.css('top', logoY + 'vh');
    logo.css('left', logoX + 'vw');

    var sidePanelW = calcRange(50, 100, scrollPercent);
